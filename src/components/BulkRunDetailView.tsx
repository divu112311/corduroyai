  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
        <div>
          <h3 className="text-slate-900">{run.fileName}</h3>
      ...
      {loading ? (
        ...
        <div className="p-8 text-center text-slate-500">No products found in this run</div>
      ) : (
        <div className="max-h-96 overflow-y-auto">
          {/* Table header */}
          <div className="px-6 py-2 bg-slate-50 border-b border-slate-100 grid grid-cols-12 gap-4 text-xs text-slate-500 uppercase tracking-wider sticky top-0">
