...
# ---------------- REGEX ----------------
ADDRULES_HEADER = re.compile(r"Additional U\.S\. Rules of Interpretation", re.I)
STOP_HEADER = re.compile(r"General Notes", re.I)
...
for i in range(START_PAGE, doc.page_count):
    ...
    for block in blocks:
        ...
        for line in text.splitlines():
            ...
            # --- START GRI ---
            if not in_gri and ADDRULES_HEADER.search(line):
                in_gri = True
                continue
...
print("✅ Additonal ingestion complete")
